...
public class RestauranteController {
	...
	private void validate(Restaurante restaurante, String name) {
		BeanPropertyBindingResult bindingResult = new BeanPropertyBindingResult(restaurante, name);
	...
	public List<Restaurante> restaurantesPorTaxaFrete(String nome, BigDecimal taxaInicial,
