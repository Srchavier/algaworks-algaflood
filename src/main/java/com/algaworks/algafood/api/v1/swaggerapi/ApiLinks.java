package com.algaworks.algafood.api.v1.swaggerapi;
...
public class ApiLinks {
    ...
    public static final TemplateVariables PAGICACAO_VARIABLES = new TemplateVariables(
    ...
    public Link linkToPedidos(String rel) {
        ...
        return Link.of(UriTemplate.of(pedidosUrl, PAGICACAO_VARIABLES.concat(filtroVariables)), rel);
    }
    ...
    public Link linkToRestaurantes(String rel) {
        String linkTo = linkTo(RestauranteController.class).toUri().toString();

        TemplateVariables filtroVariables = new TemplateVariables(
                new TemplateVariable("projecao", VariableType.REQUEST_PARAM));

        return Link.of(UriTemplate.of(linkTo, filtroVariables), rel);
    }
	...
	public Link linkToRestauranteInativacao(Long restauranteId, String rel) {
		return linkTo(methodOn(RestauranteController.class)
				.inativa(restauranteId)).withRel(rel);
	}

	public Link linkToRestauranteAtivacao(Long restauranteId, String rel) {
		return linkTo(methodOn(RestauranteController.class)
				.ativa(restauranteId)).withRel(rel);
	}
    ...
    public Link linkToRestauranteProdutos(Long restauranteId, String rel) {
        return linkTo(methodOn(RestauranteProdutoController.class).buscarTodosProdutos(restauranteId, null)).withRel(rel);
    }
    ...
    public Link linkToRestauranteProdutosFoto(Long restauranteId, Long produtoId) {
        return linkToRestauranteProdutosFoto(restauranteId, produtoId, IanaLinkRelations.SELF.value());
    }
    ...
    public Link linkToGruposUsuario(Long usuarioId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class)
                .buscarTodosGrupos(usuarioId)).withRel(rel);
    }
    ...
    public Link linkToUsuarioGrupoAssociacao(Long usuarioId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class)
                .associarPermissao(usuarioId, null)).withRel(rel);
    }
    
    public Link linkToUsuarioGrupoDesassociacao(Long usuarioId, Long grupoId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class)
                .desassociarPermissao(usuarioId, grupoId)).withRel(rel);
    }   

    public Link linkToResponsaveisRestaurante(Long restauranteId, String rel) {
        return linkTo(methodOn(RestauranteUsuarioResponsavelController.class)
                .responsavels(restauranteId)).withRel(rel);
    }
    ...
    public Link linkToRestauranteFormasPagamentoAsociacao(Long restauranteId, Long formaPagamentoId, String rel) {
        return linkTo(methodOn(RestauranteFormaPagamentoController.class).associarFormaPagamento(restauranteId,
                formaPagamentoId)).withRel(rel);
    }
    ...
    public Link linkToProduto(Long restauranteId, Long produtoId, String rel) {
        return linkTo(methodOn(RestauranteProdutoController.class)
                .buscarProdutoPorId(restauranteId, produtoId))
                .withRel(rel);
    }
    ...
    public Link linkToEntregarPedido(String codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class).entregue(codigoPedido)).withRel(rel);
    }

    public Link linkToCancelarPedido(String codigoPedido, String rel) {
        return linkTo(methodOn(FluxoPedidoController.class).cancelado(codigoPedido)).withRel(rel);
    }
