...
import com.algaworks.algafood.api.v1.swaggerapi.controller.FluxoPedidoControllerSwagger;
...
public class FluxoPedidoController implements FluxoPedidoControllerSwagger {
    ...
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public ResponseEntity<Void> cancelado(@PathVariable String codigoPedido) {
