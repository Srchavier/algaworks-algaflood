...
import com.algaworks.algafood.api.v1.swaggerapi.controller.FormaPagamentoControllerSwagger;
...
public class FormaPagamentoController implements FormaPagamentoControllerSwagger {
    ...
    public ResponseEntity<CollectionModel<FormaPagamentoModel>> listar(ServletWebRequest request) {
        ...
        var formasPagamento = formaPagamentoModelAssembler.toCollectionModel(todasFormasPagamentos);
