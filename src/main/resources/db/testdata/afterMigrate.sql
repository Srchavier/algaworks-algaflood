...
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, endereco_cep, endereco_logradouro, endereco_numero, endereco_complemeento, endereco_bairro, endereco_cidade_id, data_atualizacao, data_cadastro) values (1, 'Thai Gourmet', 10, 1,'73368640','vila real','5', '', 'arapoangas', 1, utc_timestamp, utc_timestamp);
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro) values (2, 'Thai Delivery', 9.50, 1, utc_timestamp, utc_timestamp);
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro) values (3, 'Tuk Tuk Comida Indiana', 0, 2, utc_timestamp, utc_timestamp);
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro) values (4, 'Java Steakhouse', 12, 3, utc_timestamp, utc_timestamp);
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro) values (5, 'Lanchonete do Tio Sam', 11, 4, utc_timestamp, utc_timestamp);
insert ignore into restaurante (id, nome, taxa_frete, cozinha_id, data_atualizacao, data_cadastro) values (6, 'Bar da Maria', 6, 4, utc_timestamp, utc_timestamp);
